...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <header className="sticky top-0 z-40 border-b border-border/60 bg-background/80 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          ...
          <details className="group relative md:hidden">
            <summary className="list-none rounded-md border border-border/80 bg-background/80 px-3 py-1.5 text-xs font-medium marker:content-none [&::-webkit-details-marker]:hidden">
              Menu
            </summary>
            <div className="absolute right-0 z-50 mt-1 w-52 rounded-lg border bg-popover p-2 text-sm shadow-md">
              <a href="#features" className="block rounded-md px-2 py-2 hover:bg-muted">
                Produto
              </a>
              <a href="#integracoes" className="block rounded-md px-2 py-2 hover:bg-muted">
                Integrações
              </a>
              <a href="#como-funciona" className="block rounded-md px-2 py-2 hover:bg-muted">
                Como funciona
              </a>
              <a href="#portal" className="block rounded-md px-2 py-2 hover:bg-muted">
                Proprietários
              </a>
              <Link href="/servicos" className="block rounded-md px-2 py-2 hover:bg-muted">
                Serviços
              </Link>
              <Link href="/contato" className="block rounded-md px-2 py-2 hover:bg-muted">
                Contato
              </Link>
            </div>
          </details>
      ...
      <section className="mx-auto max-w-7xl px-6 pt-16 pb-24 sm:pt-20 lg:pt-28">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            ...
            Plataforma operacional · Almeida Mares
          </Badge>
          ...
          <p className="mt-4 text-xs text-muted-foreground">
            Onboarding assistido · integração com canais e Open Finance.
          </p>
        </div>
      ...
      {/* Integrações */}
      <section id="integracoes" className="scroll-mt-24 border-t">
        <div className="mx-auto max-w-7xl px-6 py-20">
      ...
      {/* Como funciona */}
      <section id="como-funciona" className="scroll-mt-24 border-t bg-muted/30">
        <div className="mx-auto max-w-7xl px-6 py-20">
          <div className="mx-auto max-w-2xl text-center">
      ...
      <section id="portal" className="scroll-mt-24 border-t">
        <div className="mx-auto max-w-7xl px-6 py-20">
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <div className="mt-6 flex gap-3">
                <Button render={<Link href="/login?context=portal&next=/portal/painel" />}>
      ...
      <section className="border-t">
        <div className="mx-auto max-w-4xl px-6 py-20 text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            Centralize reservas, financeiro e comunicação com proprietários e hóspedes.
