...
export default function OperacaoPage() {
  return (
    <div className="space-y-5 p-6">
      <PageHeader
        title="Operação"
        description="Kanban de turnover e manutenção. Cada card vira notificação WhatsApp automática para a equipe."
      >
        <Button size="sm" className="gap-1.5" render={<Link href="/app/operacao/manutencao" />}>
          <Plus className="h-4 w-4" />
          Nova tarefa
        </Button>
      </PageHeader>

      <Tabs defaultValue="limpeza" className="space-y-5">
        <TabsList>
        ...
        <TabsContent value="limpeza" className="space-y-5 outline-none">
          ...
          <Card className="bg-amber-500/5 border-amber-500/30">
            <CardContent className="flex items-start gap-3 p-4">
              ...
              <Button variant="outline" size="sm" render={<Link href="/app/operacao/manutencao" />}>
                Ver todas
              </Button>
            </CardContent>
          </Card>
        ...
        <TabsContent value="manutencao" className="outline-none">
          <Card>
            <CardContent className="space-y-4 p-6 text-sm text-muted-foreground">
              <p>
                Ordens de serviço, anexos de fotos e aprovação de orçamentos ficam centralizadas no módulo de
                manutenção.
              </p>
              <Button render={<Link href="/app/operacao/manutencao" />}>Abrir manutenção</Button>
            </CardContent>
          </Card>
        </TabsContent>

        <TabsContent value="checkin" className="outline-none">
          <Card>
            <CardContent className="space-y-4 p-6 text-sm text-muted-foreground">
              <p>Checklists de chegada e saída, chaves digitais e comunicação com o hóspede.</p>
              <Button render={<Link href="/app/operacao/checkin-checkout" />}>Abrir check-in / check-out</Button>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="estoque" className="outline-none">
          <Card>
            <CardContent className="space-y-4 p-6 text-sm text-muted-foreground">
              <p>Consumo de insumos de limpeza e reposição por propriedade.</p>
              <Button render={<Link href="/app/operacao/estoque" />}>Abrir estoque</Button>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
      ...
      <ModuleLinks
        ...
        title="Submódulos"
        items={[
          { href: "/app/operacao/limpeza", label: "Limpeza (turnover)" },
